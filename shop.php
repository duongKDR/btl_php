...
if (isset($_GET['p_cat'])) {
    ...
    $sql_2 = "select * from products where p_cat_id='$p_cat_id' order by product_id DESC LIMIT $start_from,$per_page ";
...
if (isset($_GET['cat'])) {
    ...
    $sql_2 = "select * from products where cat_id='$cat_id'  order by product_id DESC LIMIT $start_from,$per_page";
    $res_2 = mysqli_query($con, $sql_2);
    $count = mysqli_num_rows($res_2);
    if ($count == 0) {
        echo "
